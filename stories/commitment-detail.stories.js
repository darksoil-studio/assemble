...
import "@darksoil/assemble/elements/commitment-detail.js";
...
export default {
  title: "Frontend/Elements/commitment-detail",
  tags: ["autodocs"],
  component: "commitment-detail",
  render: (args) =>
    html` <assemble-context
      .store=${store}
    >
      <commitment-detail .commitmentHash=${record.signed_action.hashed.hash}></commitment-detail>
    </assemble-context>`,
};
