    ...
    match op.flattened::<EntryTypes, LinkTypes>()? {
                ...
                OpEntry::CreateEntry { app_entry, action } => {
                    match app_entry {
                        ...
                        EntryTypes::Commitment(commitment) => {
                            validate_create_commitment(
                                EntryCreationAction::Create(action),
                                commitment,
                            )
                        }
                        EntryTypes::Satisfaction(satisfaction) => {
                            validate_create_satisfaction(
                                EntryCreationAction::Create(action),
                                satisfaction,
                            )
                        }
        ...
        FlatOp::RegisterCreateLink {
            ...
            match link_type {
                ...
                LinkTypes::OpenCallsToAction => {
                    validate_create_link_open_calls_to_action(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::MyCallsToAction => {
                    validate_create_link_my_calls_to_action(
                        action,
                        base_address,
                        target_address,
                        tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            match link_type {
                ...
                LinkTypes::OpenCallsToAction => {
                    validate_delete_link_open_calls_to_action(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::MyCallsToAction => {
                    validate_delete_link_my_calls_to_action(
                        action,
                        original_action,
                        base_address,
                        target_address,
