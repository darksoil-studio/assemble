            ...
            match update_entry {
                OpUpdate::Entry {
                    ...
                    match (app_entry, original_app_entry) {
                        (
                            EntryTypes::CollectiveCommitment(collective_commitment),
                            EntryTypes::CollectiveCommitment(
        ...
        OpType::RegisterCreateLink {
            ...
            match link_type {
                ...
                LinkTypes::PromiseToSatisfactions => {
                    validate_create_link_promise_to_satisfactions(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                OpRecord::UpdateEntry {
                    ...
                    match app_entry {
                        ...
                        EntryTypes::CollectiveCommitment(collective_commitment) => {
                            ...
                            if let ValidateCallbackResult::Valid = result {
                                let original_collective_commitment: Option<
                                    CollectiveCommitment,
                                > = original_record
                                    .entry()
                                    .to_app_option()
                                    .map_err(|e| wasm_error!(e))?;
                                let original_collective_commitment = match original_collective_commitment {
