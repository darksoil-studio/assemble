...
async fn create_satisfaction_test() {
    ...
    let sample = sample_satisfaction_1(&conductors[0], &alice_zome, None).await;
...
async fn create_and_update_satisfaction() {
    ...
    let sample_1 = sample_satisfaction_1(&conductors[0], &alice_zome, None).await;
    ...
    let sample_2 = sample_satisfaction_2(&conductors[0], &alice_zome, None).await;
